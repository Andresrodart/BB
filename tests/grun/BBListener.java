...
public interface BBListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by {@link BBParser#acceso_arreglo}.
	 * @param ctx the parse tree
	 */
	void enterAcceso_arreglo(BBParser.Acceso_arregloContext ctx);
	/**
	 * Exit a parse tree produced by {@link BBParser#acceso_arreglo}.
	 * @param ctx the parse tree
	 */
	void exitAcceso_arreglo(BBParser.Acceso_arregloContext ctx);
	/**
	...
	/**
	 * Enter a parse tree produced by {@link BBParser#metodo_miembro}.
	 * @param ctx the parse tree
	 */
	void enterMetodo_miembro(BBParser.Metodo_miembroContext ctx);
	/**
	 * Exit a parse tree produced by {@link BBParser#metodo_miembro}.
	 * @param ctx the parse tree
	 */
	void exitMetodo_miembro(BBParser.Metodo_miembroContext ctx);
	/**
	...
	/**
	 * Enter a parse tree produced by the {@code etiqueta_de_acceso_arreglo}
	 * labeled alternative in {@link BBParser#expresion}.
	 * @param ctx the parse tree
	 */
	void enterEtiqueta_de_acceso_arreglo(BBParser.Etiqueta_de_acceso_arregloContext ctx);
	/**
	 * Exit a parse tree produced by the {@code etiqueta_de_acceso_arreglo}
	 * labeled alternative in {@link BBParser#expresion}.
	 * @param ctx the parse tree
	 */
	void exitEtiqueta_de_acceso_arreglo(BBParser.Etiqueta_de_acceso_arregloContext ctx);
	/**
